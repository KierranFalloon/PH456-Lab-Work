...
plt.title(r'Cross-correlation $\approx %1.2f$, $\chi^2 \approx %s, \rho_{XY}\approx %1.4f$' %(correl1, pcg64chi1, pearsoncoeff1), fontsize = 10)
plt.tight_layout()
...
plt.title(r'Cross-correlation $\approx %1.2f$, $\chi^2 \approx %s, \rho_{XY}\approx %1.4f$' %(correl2, pcg64chi2, pearsoncoeff2), fontsize = 10)
plt.tight_layout()
...
plt.title(r'Cross-correlation $\approx %1.2f$, $\chi^2 \approx %s, \rho_{XY}\approx %1.4f$' %(correl3, mt19937chi1, pearsoncoeff3), fontsize = 10)
plt.tight_layout()
...
plt.title(r'Cross-correlation $\approx %1.2f$, $\chi^2 \approx %s, \rho_{XY}\approx %1.4f$' %(correl4, mt19937chi2, pearsoncoeff4), fontsize = 10)
plt.tight_layout()
