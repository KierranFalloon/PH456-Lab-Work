...
def MonteCarlo_Integrator(func, lim_array, sample_points):
    ...
    return integral, variance, root_mean_squared # Return values
...
integral1, variance1, rms1 = MonteCarlo_Integrator(function1,[0,1],10000)
print(integral1, variance1, rms1)

integral2, variance2, rms2 = MonteCarlo_Integrator(function2,[0,1],10000)
print(integral2, variance2, rms2)

integral3, variance3, rms3 = MonteCarlo_Integrator(function3,[-2,2],10000)
print(integral3, variance3, rms3)

integral4, variance4, rms4 = MonteCarlo_Integrator(function4, [0,1,0,1], 10000)
print(integral4, variance4, rms4)
...
integral5, variance5, rms5 = MonteCarlo_Integrator(sphere_func_3, [-2,2,-2,2,-2,2], 10000)
integral6, variance6, rms6 = MonteCarlo_Integrator(sphere_func_5, [-2,2,-2,2,-2,2,-2,2,-2,2], 10000)
print(integral5, variance5, rms5)
print(integral6, variance6, rms6)
